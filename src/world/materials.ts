...
const defs: MaterialDef[] = [
  ...
  { id: Mat.Iron, name: 'Iron Ore', texture: 'ore', palette: [0x77737e, 0x302e36, 0xc8b4a6, 0xf0e2d6], hardness: 1.6, tier: 1, drop: 'iron_ore', volumePerItem: 1.5, emissive: 0.03, particle: 0xd8c0b0 },
