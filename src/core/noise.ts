// Seeded simplex noise (2D + 3D) and a small deterministic PRNG.
// Everything procedural in the world derives from these, so a seed fully
// determines the generated world.
...
/** Stable integer hash of up to 3 ints + seed, returns [0,1). */
...
export class SimplexNoise {
  ...
  /** Fractal 2D noise, roughly in [-1,1]. */
  ...
  /** Ridged 2D noise in [0,1], sharp crests — good for mountain ranges. */
